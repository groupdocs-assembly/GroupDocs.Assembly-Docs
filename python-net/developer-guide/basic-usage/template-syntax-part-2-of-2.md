...
url: assembly/python-net/template-syntax-part-2-of-2
...
*   `Selector` stands for a lambda function returning a value and taking an enumeration item as its single argument. See [Using Lambda Functions](https://docs.groupdocs.com/assembly/python-net/template-syntax-part-1-of-2/#using-lambda-functions) for more information.
